...
class TestDeleteCriminalRecordViewmodel:
    def test_delete_criminal_record_viewmodel(self):
        criminal = Criminal("Bitu","234","Matador de pomba",GENDER.MALE,FAVORITE_REGION.ROBBINSVILLE,"revolver no pombo", Crime("234", TYPE_CRIME.CRIME_AGAINST_SELFAS_THE_BEST_PROJECT))
        
        criminal_record = CriminalRecord("234", True, 90, criminal)
        ...
        assert response["criminal_record"]["criminal"]["crime"] == criminal_record.criminal.to_dict()["crime"]
